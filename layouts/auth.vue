...
.gradient {
  ...
  inset: 0;
  pointer-events: none;
  background: radial-gradient(80% 80% at 50% 50%, rgb(var(--color-primary-500) / 0.25) 0, #FFF 100%);
}

.dark {
  .gradient {
    background: radial-gradient(50% 50% at 50% 50%, rgb(var(--color-violet-400) / 0.1) 0, rgb(var(--color-gray-950)) 100%);
  }
}
