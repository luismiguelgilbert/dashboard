...
export const bitacora_reasons_sort_enum_keys_schema = z.enum(['1', '2']);
export type bitacora_reasons_sort_enum_keys = z.infer<typeof bitacora_reasons_sort_enum_keys_schema>;
export const bitacora_reasons_sort_enum_client: sort_enum_array[] = [
  { id: '1', label: 'Motivo' },
  { id: '2', label: 'Estado' },
];
export const bitacora_reasons_sort_enum_server: sort_enum_array[] = [
  { id: '1', label: 'a.name_es' },
  { id: '2', label: 'a.is_active' },
];

export const bitacora_reasons_query_schema = z.object({
  ...
  sort: bitacora_reasons_sort_enum_keys_schema.catch('1'),
...
export type bitacora_reasons_query = z.infer<typeof bitacora_reasons_query_schema>;

export const bitacora_reasons_schema = z.object(
  {
    id: z.string().default(''),
