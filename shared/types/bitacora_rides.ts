...
export const bitacora_rides_schema = z.object(
  {
    ...
    // ride_start_km: z.number().nullable(),
    // ride_start_comment: z.string().nullable().optional().default(''),
    // ride_end: z.string().nullable(),
    // ride_end_km: z.number().nullable(),
    // ride_end_comment: z.string().nullable().optional().default(''),
