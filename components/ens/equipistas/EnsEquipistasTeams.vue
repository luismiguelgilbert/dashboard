...
//LOOKUP DATA
const { data: dataTeams } = await useFetch<type_ens_teams_lookup[]>('/api/lookups/ens_teams');
const { data: dataServices } = await useFetch<type_ens_services_lookup[]>('/api/lookups/ens_services');
