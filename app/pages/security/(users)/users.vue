...
const { sortItems, queryPayload, computedQueryKey, computedQueryKeyRef, keyRef, isLoading, selectedRecordId, selectedRowData, hasFilter, filterActiveItems, filterSexItems } = storeToRefs(store);
