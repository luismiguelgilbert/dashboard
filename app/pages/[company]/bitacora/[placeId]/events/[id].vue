...
const { dataRecord, dataRecordFetching, dataRecordUpdate, dataRecordUpdating } = useBitacoraEventsQueries();
...
<template>
  <div class="wrapper">
    ...
    <main v-if="!dataRecordFetching && selectedRowData">
      <EventFormContentBasic :vertical="isMobile" :disable="dataRecordFetching || dataRecordUpdating" />
      <EventFormContentAvatar :vertical="isMobile" :disable="dataRecordFetching || dataRecordUpdating" />
    </main>
  </div>
</template>
