...
const { dataRecord, dataRecordFetching, dataRecordUpdate, dataRecordUpdating } = useBitacoraReasonsQueries();
...
<template>
  <div class="wrapper">
    ...
    <main v-if="!dataRecordFetching && selectedRowData">
      <ReasonFormContentBasic :vertical="isMobile" :disable="dataRecordFetching || dataRecordUpdating" />
    </main>
  </div>
</template>
